 ...
 */
final class Version20220422171007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trt_candidature (id INT AUTO_INCREMENT NOT NULL, annonce_id INT DEFAULT NULL, profil_id INT DEFAULT NULL, INDEX IDX_ECEC7AFB8805AB2F (annonce_id), INDEX IDX_ECEC7AFB275ED078 (profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trt_profilcandidat (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, profession_id INT DEFAULT NULL, experience_id INT DEFAULT NULL, trt_annonce_id INT DEFAULT NULL, nom VARCHAR(50) DEFAULT NULL, prenom VARCHAR(50) DEFAULT NULL, cv VARCHAR(150) DEFAULT NULL, image VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_8E47E91C79F37AE5 (id_user_id), INDEX IDX_8E47E91CFDEF8996 (profession_id), INDEX IDX_8E47E91C46E90E27 (experience_id), INDEX IDX_8E47E91C5F55DC66 (trt_annonce_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trt_profilrecruteur (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, nom VARCHAR(50) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(8) DEFAULT NULL, ville VARCHAR(100) DEFAULT NULL, etablissement VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_1834883479F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trt_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, valider TINYINT(1) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, profil TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_B0E89F99E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trt_candidature ADD CONSTRAINT FK_ECEC7AFB8805AB2F FOREIGN KEY (annonce_id) REFERENCES trt_annonce (id)');
        $this->addSql('ALTER TABLE trt_candidature ADD CONSTRAINT FK_ECEC7AFB275ED078 FOREIGN KEY (profil_id) REFERENCES trt_profilcandidat (id)');
        ...
        $this->addSql('ALTER TABLE trt_profilcandidat ADD CONSTRAINT FK_8E47E91C5F55DC66 FOREIGN KEY (trt_annonce_id) REFERENCES trt_annonce (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trt_candidature DROP FOREIGN KEY FK_ECEC7AFB8805AB2F');
        $this->addSql('ALTER TABLE trt_profilcandidat DROP FOREIGN KEY FK_8E47E91C5F55DC66');
        ...
        $this->addSql('ALTER TABLE trt_candidature DROP FOREIGN KEY FK_ECEC7AFB275ED078');
